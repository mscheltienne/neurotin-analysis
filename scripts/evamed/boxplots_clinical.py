...
fname = r'/Users/scheltie/Desktop/THI.csv'
df = read_csv_evamed(fname)
thi = parse_thi(df, participants)
thi = thi[thi['visit'].isin(('Baseline', 'Post-assessment'))]

fname = r'/Users/scheltie/Desktop/STAI.csv'
df = read_csv_evamed(fname)
stai = parse_stai(df, participants)

fname = r'/Users/scheltie/Desktop/BDI.csv'
df = read_csv_evamed(fname)
bdi = parse_bdi(df, participants)

fname = r'/Users/scheltie/Desktop/PSQI.csv'
df = read_csv_evamed(fname)
psqi = parse_psqi(df, participants)

fname = r'/Users/scheltie/Desktop/WHODAS.csv'
df = read_csv_evamed(fname)
